...
import { faArrowUpRightFromSquare, faArrowRight, faFileLines, faStar, faCircleCheck, faUserPen, faLightbulb, faGear, faMobileScreen, faServer } from '@fortawesome/free-solid-svg-icons'
...
const custom_notes_saver = () => {
    return (
        <div className='px-10 overflow-hidden py-8 gap-5 bg-[linear-gradient(135deg,#080D1F_0%,#101A35_35%,#172554_65%,#24164F_100%)] pb-40'>
            ...
            className='flex flex-col ml-40 py-40'>
                <h2 className='text-[40px] font-bold bg-linear-to-r from-[#3B82F6] via-[#8B5CF6] to-[#3239b9d2] bg-clip-text text-transparent'>Custom Notes Saver</h2>
            ...
            <div>
                <motion.div initial={{opacity: 0, scale: 0.2, x: -500}} whileInView={{opacity: 1, x: 0, scale: 1}} transition={{duration: 2}} viewport={{once: true, amount: 0.8}}>
                    <h2 className='text-[35px] font-bold text-white'>Screenshots</h2>
                    <div className='mt-1 h-1 w-25 rounded-full bg-linear-to-r from-[#3B82F6] via-[#8B5CF6] to-[#3239b9d2]'></div>
                </motion.div>

                <motion.div initial={{opacity: 0, scale: 0.2}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 2}} viewport={{once: true, amount: 0.9}}
                className='grid grid-cols-2 gap-20 pt-15'>
                    <div className='rounded-2xl overflow-hidden border-2 border-[#5f8dce]'><img src={ss1} alt="HomeScreenshot" className='rounded-2xl'/></div>
                    <div className='rounded-2xl overflow-hidden border-2 border-[#5f8dce]'><img src={ss2} alt="NotesScreenshot" className='rounded-2xl'/></div>
                    <div className='rounded-2xl overflow-hidden border-2 border-[#5f8dce]'><img src={ss3} alt="SearchScreenshot"  className='rounded-2xl'/></div>
                    <div className='rounded-2xl overflow-hidden border-2 border-[#5f8dce]'><img src={ss4} alt="ShareScreenshot" className='rounded-2xl'/></div>
                </motion.div>
            </div>
            ...
            <div className='grid grid-cols-3 gap-10 mt-50'>
                ...
                className='rounded-xl bg-linear-to-r from-cyan-400 via-blue-500 to-purple-600 p-0.5'>
                    <div className='h-full flex flex-col px-5 py-8 rounded-xl bg-[#0f1731]'>
                        <div className='flex gap-5 items-center'>
                            <div><FontAwesomeIcon icon={faFileLines} className='text-[28px] text-[#9333EA]'/></div>
                            <div>
                ...
                className='rounded-xl bg-linear-to-r from-cyan-400 via-blue-500 to-purple-600 p-0.5'>
                    <div className='h-full flex flex-col px-5 py-8 rounded-xl bg-[#0f1731]'>
                        <div className='flex gap-5 items-center'>
                            <div><FontAwesomeIcon icon={faStar} className='text-[28px] text-[#9333EA]'/></div>
                            <div>
            ...
            <div className='grid grid-cols-3 gap-10 mt-50'>
                ...
                className='rounded-xl bg-linear-to-r from-cyan-400 via-blue-500 to-purple-600 p-0.5'>
                    <div className='h-full flex flex-col px-5 py-8 rounded-xl bg-[#0f1731]'>
                        <div className='flex gap-5 items-center'>
                            <div><FontAwesomeIcon icon={faUserPen} className='text-[28px] text-[#9333EA]'/></div>
                            <div>
                ...
                className='rounded-xl bg-linear-to-r from-cyan-400 via-blue-500 to-purple-600 p-0.5'>
                    <div className='h-full flex flex-col px-5 py-8 rounded-xl bg-[#0f1731]'>
                        <div className='flex gap-5 items-center'>
                            <div><FontAwesomeIcon icon={faLightbulb} className='text-[28px] text-[#9333EA]'/></div>
                            <div>
